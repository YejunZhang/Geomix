...
def parse_version():
    ...
    with open(os.path.join("geomix", "__init__.py"), "r") as f:
        content = f.read()
...
setup(
    ...
    license="MIT",
    description="GeoMix: descriptor-free visual localization via global context and multi-detector training",
    ...
    author="Yejun Zhang, Xinjue Wang, Zihan Wang, Esa Rahtu, Juho Kannala",
