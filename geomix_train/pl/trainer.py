...
from geomix import models
# from GMcolor import models
from geomix.data.dataset_loaders import init_data_loader
from geomix.utils.loss import compute_loss
from geomix.utils.metrics import compute_metrics_batch
    ...
    def __init__(self, config):
        ...
        if config.matcher_class == "BPnPMatcher":
            ...
            self.matcher = vars(models)[config.matcher_class](
                ...
                num_registers=getattr(config, 'num_registers', 4),
            )
...
def train(args, exp_name):
    ...
    # Callbacks
    # Save only the best checkpoint overall
    ...
    # Save every i-th epoch checkpoint
