...
def init_args():
    ...
    parser.add_argument("--num_registers", type=int, default=4,
                        help="Number of global context (register) nodes")
    ...
    parser.add_argument("--detectors", type=str, nargs="*", default=["sift", "superpoint", "disk"],
                        help="List of detectors to use for training (e.g., sift superpoint disk)")
    parser.add_argument(
